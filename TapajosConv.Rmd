...
data <- data %>% 
  mutate(P_NaHCO3 = (P_NaHCO3/bulk_density),
         P_NaOH = (P_NaHCO3/bulk_density),
         P_1M_HCl = (P_1M_HCl/bulk_density),
          P_conc_HCl =  (P_conc_HCl/bulk_density),
         P_H2SO4 =  (P_H2SO4/bulk_density))
```

```{r export data}

write_csv(data,"McGroddy Brazil paper.csv")
